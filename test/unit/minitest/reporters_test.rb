...
module MiniTestReportersTest
  class ReportersTest < TestCase
    def test_chooses_the_rubymine_reporter_when_necessary
      ...
      reporters = MiniTest::Reporters.choose_reporters [], { 'RM_INFO' => 'x' }, { io: StringIO.new }
      assert_instance_of MiniTest::Reporters::RubyMineReporter, reporters[0]

      reporters = MiniTest::Reporters.choose_reporters [], { 'TEAMCITY_VERSION' => 'x' }, { io: StringIO.new }
      assert_instance_of MiniTest::Reporters::RubyMineReporter, reporters[0]
    ensure
